...
export const defaultFeatureSettings = (): Record<FeatureId, Record<string, any>> => ({
  ...
  hoang_co: {
     ...
     */
    break_hop: true,
    /** Mỗi hop cắm tối đa N ô (cheby) từ cờ built — mặc định 1 (server not_adjacent nếu xa) */
    break_hop_max: 1,
     ...
     * cheby≤1 tới mỏ rồi attack_position tới khi captured. Mặc định ưu tiên mỏ gần trước, rồi lan xa dần.
     */
